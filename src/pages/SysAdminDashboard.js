  ...
  const HomeContent = (
    <div>
      ...
      <div style={{ display: "flex", gap: "25px", marginTop: "30px" }}>
        <div style={statCard}>
          <h2 style={{ margin: 0, fontSize: "32px", color: "#ff4757" }}>
            1,250
          </h2>
        ...
        <div style={statCard}>
          ...
          <p style={{ color: "#7f8c8d", fontWeight: "bold" }}>Server Status</p>
        </div>
        <div style={statCard}>
          <h2 style={{ margin: 0, fontSize: "32px", color: "#ff4757" }}>0</h2>
          <p style={{ color: "#7f8c8d", fontWeight: "bold" }}>Cảnh báo</p>
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "Arial" }}>
        ...
        <nav>
          <ul style={{ listStyle: "none", padding: 0 }}>
            <li style={navItemStyle}>
              <Link to="/sysadmin/users" style={linkStyle}>
                👤 Quản lý người dùng
              </Link>
            </li>
            <li style={navItemStyle}>
              <Link to="/sysadmin/permissions" style={linkStyle}>
                🔐 Phân quyền
              </Link>
            </li>
            <li style={navItemStyle}>
              <Link to="/sysadmin/logs" style={linkStyle}>
                📋 Nhật ký
              </Link>
            </li>
          </ul>
      ...
      <div style={{ flex: 1, padding: "40px", background: "#f8f9fa" }}>
        <Routes>
          ...
          <Route path="permissions" element={<SysAdminPermissions />} />
