...
import TeacherNotifications from './TeacherNotifications'; // Import trang thông báo mới
    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Arial' }}>
            ...
            <div style={{ width: '260px', background: '#16211a', color: 'white', padding: '20px' }}>
                ...
                <button onClick={() => window.location.href='/login'} style={{marginTop: '30px', width: '100%', padding: '10px', background: '#c0392b', color: 'white', border: 'none', cursor: 'pointer', borderRadius: '4px'}}>
                    Đăng xuất
                </button>
            </div>
