  ...
  const HomeContent = (
    <div>
      ...
      <div style={{ display: "flex", gap: "25px", marginBottom: "40px" }}>
        <div style={statCard}>
          <h2 style={{ margin: 0, fontSize: "32px", color: "#00ff88" }}>3</h2>
          <p style={{ color: "#7f8c8d", fontWeight: "bold" }}>
            Lớp học đảm nhận
          </p>
        </div>
        <div style={statCard}>
          <h2 style={{ margin: 0, fontSize: "32px", color: "#00ff88" }}>15</h2>
          <p style={{ color: "#7f8c8d", fontWeight: "bold" }}>
            Tiết dạy trong tuần
          </p>
        </div>
        <div style={statCard}>
          <h2 style={{ margin: 0, fontSize: "32px", color: "#00ff88" }}>2</h2>
      ...
      >
        ...
        <ul style={{ listStyle: "none", padding: 0 }}>
          <li style={navItemStyle}>
            <Link to="/teacher/schedule" style={linkStyle}>
              {" "}
              👨‍🏫 Lịch giảng dạy
            </Link>
          </li>
          <li style={navItemStyle}>
            <Link to="/teacher/notifications" style={linkStyle}>
              {" "}
              🔔 Thông báo
            </Link>
          </li>
