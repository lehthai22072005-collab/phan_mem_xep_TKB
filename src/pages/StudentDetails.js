  ...
  return (
    <div>
      <h2 style={{ color: "#2c3e50", marginBottom: "8px" }}>
        SV_BM 3 - XEM CHI TIẾT MÔN HỌC
      </h2>
      <p style={{ color: "#7f8c8d", marginBottom: "20px" }}>
        Chỉ hiển thị chi tiết các môn sinh viên đã đăng ký.
      </p>
        ...
        >
          {registeredCourses.map((course, index) => (
            ...
            >
              ...
              <h3 style={{ margin: "0 0 12px 0", color: "#3498db" }}>
                {course.name}
              </h3>
              <p>
                <strong>Mã môn học:</strong> {course.id}
              </p>
              <p>
                <strong>Số tín chỉ:</strong> {course.credits}
              </p>
              <p>
                <strong>Thời gian:</strong> {formatTime(course)}
              </p>
              <p>
                <strong>Giáo viên:</strong> {course.teacher}
              </p>
              <p>
                <strong>Phòng học:</strong> {course.room}
              </p>
              <p>
